...
# Usage: irm https://raw.githubusercontent.com/Adolph-Adolf/Antigravity-Manager/main/install.ps1 | iex
#
...
$Repo = "Adolph-Adolf/Antigravity-Manager"
...
function Get-ReleaseVersion {
    ...
    Write-Host '  $Version = "4.3.3"; irm https://raw.githubusercontent.com/Adolph-Adolf/Antigravity-Manager/main/install.ps1 | iex' -ForegroundColor Yellow
    return $false
}
